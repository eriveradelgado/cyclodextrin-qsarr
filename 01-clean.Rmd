...
The dataset from Suzuki et al (2001) requires less cleaning as the conditions for the experiment are already standardized. The dataset contains three columns:
...
The Singh (2015) dataset, like the Suzuki information, is largely cleaned and only needs to be filtered for reported Gibbs free energy change. Out of 114 observations, 112 are retained. The results will be saved in `data/clean`.
