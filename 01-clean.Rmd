...
The relevant columns for later steps are `host`, `guest`, and `dG`. These will be saved in `affinity/clean`. In total, 1367 observations were cleaned to 478 observations.
